...
$(document).ready(function () {
  ...
  //     hideMethod: "fadeOut",
  //   };
  //   toastr.success("Welcome to Dashboard", "Vijay!");
  // }
  ...
  if (infoTeoaset !== null) {
    infoTeoaset.on("click", function () {
      ...
      if (thisId === "toaster-info") {
        toastr.info("Welcome to ", " Info message");
      } else if (thisId === "toaster-success") {
        toastr.success("Welcome to ", "Success message");
      } else if (thisId === "toaster-warning") {
        toastr.warning("Welcome to ", "Warning message");
      } else if (thisId === "toaster-danger") {
        toastr.error("Welcome to ", "Danger message");
      }
    });
  }
