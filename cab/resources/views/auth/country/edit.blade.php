...
<div>
    ...
    <form class="row" action="{{route('admin.user-management.country.update', $country->id)}}" method="POST" enctype="multipart/form-data">
        <div class="col-md-9">
            <div class="card">
                <div class="card-body">
                    @csrf
                    ...
                    <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="name" name="name" class="form-control" value="{{ $country->name }}" placeholder="Name" required />
                        @if($errors->has('name'))
                    ...
                    <div class="form-group {{ $errors->has('nice_name') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="nice_name" name="nice_name" class="form-control" value="{{ $country->nice_name }}" placeholder="Nice Name" required />
                    ...
                    <div class="form-group {{ $errors->has('iso') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="iso" name="iso" class="form-control" value="{{ $country->iso }}" placeholder="Iso" required />
                        @if($errors->has('iso'))
                        <em class="invalid-feedback">
                            {{ $errors->first('iso') }}
                        </em>
                    ...
                    <div class="form-group {{ $errors->has('iso3') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="iso3" name="iso3" class="form-control" value="{{ $country->iso3 }}" placeholder="Iso3" required />
                        @if($errors->has('iso3'))
                        <em class="invalid-feedback">
                            {{ $errors->first('iso3') }}
                        </em>
                    ...
                    <div class="form-group {{ $errors->has('phone_code') ? 'has-error' : '' }}">
                        ...
                        <input type="number" id="phone_code" name="phone_code" class="form-control" value="{{ $country->phone_code }}" placeholder="Phone Code" required />
                    ...
                    <div class="form-group {{ $errors->has('num_code') ? 'has-error' : '' }}">
                        ...
                        <input type="number" id="num_code" name="num_code" class="form-control" value="{{ $country->num_code }}" placeholder="Num Code" required />
