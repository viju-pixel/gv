...
@section('title') Show Permission @endsection
@section('content')
<div>
    <div class="row">
        <div class="col-12">
            <div class="d-flex flex-row-reverse justify-content-end mb-4 pb-2 gap-4">
                <h1 class="page-title">Show Permission</h1>
    ...
    <div class="row">
        <div class="col-12">
            <table class="table table-bordered table-responsive" aria-describedby="roles-details">
                ...
                <tr>
                    <th>Create at</th>
                    <td>{{$permission->created_at->format('j F Y')}}</td>
                </tr>
                <tr>
                    <th>Updated at</th>
                    <td>{{$permission->updated_at->format('j F Y')}}</td>
                </tr>
            </table>
        </div>
    </div>
